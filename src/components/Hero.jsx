  ...
  return (
    <section id="home" className="hero">
      ...
      >
        ...
        >
          Passionate Full Stack Developer specializing in building robust backend systems 
          and interactive web applications. I transform complex problems into elegant, 
